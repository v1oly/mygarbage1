...
class DetailsView: UIView {
    ...
    func setup() {
        ...
        selectColorButton.center = CGPoint(x: 125,
        ...
        submitPieAdd.center = CGPoint(x: self.bounds.midX + 55,
        ...
        setTextToSegmentField.frame.origin = CGPoint(x: selectColorButton.frame.origin.x + 100,
        ...
        pieValueStepper.frame.origin = CGPoint(x: selectColorButton.frame.origin.x - 20,
    ...
    func labelSetup() {
        ...
        colorPickerLabel.frame.origin = CGPoint(x: selectColorButton.frame.origin.x - 16,
        ...
        setTextToSegmentFieldLabel.frame.origin = CGPoint(x: colorPickerLabel.frame.origin.x + 160,
                                                          y: selectColorButton.frame.origin.y - 10)
    ...
    func addPieToDiagram(_ sender: UIButton) {
        guard !setTextToSegmentField.text!.isEmpty  else {
            return
        }
        print("added")
