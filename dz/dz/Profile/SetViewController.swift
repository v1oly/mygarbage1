...
class SetView: UIView { // swiftlint:disable:this type_body_length
    ...
    func setupLabels() { // swiftlint:disable:this function_body_length
        ...
        arrayCreateTimeLabel1.text = "Creating set Time:"
    ...
    func createArrayAndTest(_ sender: UIButton) { // swiftlint:disable:this function_body_length
        ...
        currentTime = Date()
        let setCount1 = setArray.count - 1
        let setCount2 = setArray.count - 5
        let setCount3 = setArray.count - 10
        
        for _ in 0...9 {
            setArray.removeFirst()
            
            if setArray.count == setCount1 {
                remove1EntryTime = Date().timeIntervalSince(currentTime)
            }
            
            if setArray.count == setCount2 {
                remove5EntryTime = Date().timeIntervalSince(currentTime)
            }
            
            if setArray.count == setCount3 {
