...
//    func addToDataBase(text: String, index: Int) -> TestModel? {
//        guard let context = persistenceContainer?.viewContext else { return nil }
//        let newModel = TestModel(context: context)
//        newModel.index = Int16(index)
//        newModel.text = text
//        do {
//            try context.save()
////            persistenceContainer?.persistentStoreCoordinator.
//        } catch let error {
//            print(error)
//        }
//        return newModel
